...
class Category(models.Model):
    ...
    title = models.CharField(max_length=100, default="My Category")
...
class Vendor(models.Model):
    ...
    address = models.CharField(max_length=100, default="123 Kilimani")
    contact = models.CharField( max_length=100, default="+254791036509")
...
class Product(models.Model):
    pid = ShortUUIDField(
        unique=True, length=10, max_length=20, prefix="prd", alphabet="abcdefgh12345"
    )
    title = models.CharField(max_length=100, default="Prod Title")
    image = models.ImageField(upload_to=user_directory_path, default="product.jpg")
    description = models.TextField(null=True, blank=True, default="Prod Description")
