# Generated by Django 4.2.3 on 2024-01-11 16:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(default='My Category', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(default='Prod Title', max_length=100)),
                ('image', models.ImageField(default='product.jpg', upload_to=core.models.user_directory_path)),
                ('description', models.TextField(blank=True, default='Prod Description', null=True)),
                ('price', models.DecimalField(decimal_places=2, default='100', max_digits=9999999999999)),
                ('old_price', models.DecimalField(decimal_places=2, default='200', max_digits=9999999999999)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cid', shortuuid.django_fields.ShortUUIDField(alphabet='abcdefgh12345', length=10, max_length=20, prefix='ven', unique=True)),
                ...
                ('address', models.CharField(default='123 Kilimani', max_length=100)),
                ('contact', models.CharField(default='+254791036509', max_length=100)),
